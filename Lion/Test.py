...
class Lion_test(TestCase):
    ...
    def test_init(self):
        # L = Lion()
        self.assertTrue(self.L.hungry, 'Initial state is wrong')

    def test_get(self):
        # L = Lion()
        self.assertTrue(self.L.get_state(), 'Initial state is wrong')

    def test_change(self):
        # L = Lion()
        self.L.change_state()
        self.assertFalse(self.L.hungry, 'Initial state is wrong')
